...
//declaracion de variables
    ...
    // uso de la funcion startmatrix, luego se hace un do donde esta la logica principal del juego
...
//checkeo de condiciones para funcionamiento del juego
        if ((slot1 + slot2) == 10)
        {
